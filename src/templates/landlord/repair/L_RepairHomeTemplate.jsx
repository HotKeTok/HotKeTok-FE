...
// 필요 없으면 삭제 가능
// import iconHammer from '../../../assets/repair/icon-hammer.png';
      ...
      <ScrollableContent>
        ...
        <TopSurface>
          <RowBetween>
            ...
            {/* <Hammer src={iconHammer} alt="" /> */}
          </RowBetween>

          {hasActive ? (
            <Column $gap={12} style={{ padding: '8px 20px 0' }}>
...
// const Hammer = styled.img`width: 28px; height: 28px;`;
